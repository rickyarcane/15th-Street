  ...
  head: () => ({
    meta: [
      { title: "Contact — Crown Management" },
      {
        name: "description",
        content:
          "Talk to Crown Management about a stay, a piece from the collection, or anything else. We reply within 24 hours.",
      },
          ...
          <div className="space-y-8">
            <div>
              ...
              <a
                ...
                className="font-display text-[28px] text-clay underline underline-offset-4 hover:decoration-2"
              >
                info@crownmgmt.biz
              </a>
            </div>
            ...
            <div className="pt-4 border-t border-line space-y-2">
              ...
              <Link
                to="/properties"
                className="block text-clay underline underline-offset-4 hover:decoration-2"
              >
                Browse Properties →
              </Link>
              <Link
